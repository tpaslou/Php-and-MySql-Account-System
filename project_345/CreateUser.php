...
$sql="INSERT INTO customer(name,acc_num,exp_date,cr_limit,curr_amount,rem_dept)VALUES('$name','$acc_number','$exp_date','$cr_limit','$curr_amount','$rem_dept')";
...
<nav class="w3-sidenav w3-white w3-card-2 w3-animate-left" style="display:none" id="mySidenav">
	...
	<br>
	<h2 style="color: #196666;text-align:center;">Register as Customer</h2>
	<div class="forms">
